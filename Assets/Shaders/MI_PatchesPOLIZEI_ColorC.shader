Shader "Unreal/MI_PatchesPOLIZEI_ColorC"
{
    Properties
    {
		...
		Material_Texture2D_1( "Diffuse", 2D ) = "white" {}
		Material_Texture2D_2( "IDMap", 2D ) = "white" {}
		Material_Texture2D_3( "Back Color", 2D ) = "white" {}
		Material_Texture2D_4( "Text Color", 2D ) = "white" {}
		Material_Texture2D_5( "ORM", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_PatchesPOLIZEI_ColorC.hlsl"
