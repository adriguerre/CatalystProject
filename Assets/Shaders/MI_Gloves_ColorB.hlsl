...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.274811,0.302083,0.185655,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.274811,0.302083,0.185655,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.725189,0.697917,0.814345,2.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.052083,0.052083,0.052083,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.052083,0.052083,0.052083,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.947917,0.947917,0.947917,2.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.120314,0.125000,0.066406,1.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.120314,0.125000,0.066406,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(0.879686,0.875000,0.933594,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(1.000000,5.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(0.125000,0.101490,0.059896,1.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(0.125000,0.101490,0.059896,0.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(0.875000,0.898510,0.940104,0.000000);//(Unknown)
	Material.PreshaderBuffer[16] = float4(1.000000,0.500000,0.500000,0.500000);//(Unknown)
