...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.250000,0.195999,0.177083,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.250000,0.195999,0.177083,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.750000,0.804001,0.822917,2.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.526042,0.400786,0.234621,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.526042,0.400786,0.234621,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.473958,0.599214,0.765379,4.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.338542,0.221627,0.130480,1.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.338542,0.221627,0.130480,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(0.661458,0.778373,0.869520,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(1.000000,3.500000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(0.500000,0.500000,0.500000,1.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(0.500000,0.500000,0.500000,0.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(0.500000,0.500000,0.500000,0.100000);//(Unknown)
