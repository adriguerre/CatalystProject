...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.458333,0.372108,0.207682,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.458333,0.372108,0.207682,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.541667,0.627892,0.792318,2.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.343750,0.275938,0.152181,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.343750,0.275938,0.152181,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.656250,0.724062,0.847819,2.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.458333,0.305482,0.145616,1.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.458333,0.305482,0.145616,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(0.541667,0.694518,0.854384,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(1.000000,5.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(0.391572,0.341914,0.219526,1.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(0.391572,0.341914,0.219526,0.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(0.608428,0.658086,0.780474,0.000000);//(Unknown)
