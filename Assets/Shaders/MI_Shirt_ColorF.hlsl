...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.371238,0.278894,0.201556,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.371238,0.278894,0.201556,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.628762,0.721106,0.798444,2.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.371238,0.278894,0.201556,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.371238,0.278894,0.201556,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.628762,0.721106,0.798444,2.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.463542,0.309609,0.181071,1.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.463542,0.309609,0.181071,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(0.536458,0.690391,0.818929,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(1.000000,5.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(0.380208,0.239905,0.124756,1.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(0.380208,0.239905,0.124756,0.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(0.619792,0.760095,0.875244,0.000000);//(Unknown)
