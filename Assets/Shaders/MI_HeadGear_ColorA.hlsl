...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.375000,0.323937,0.226562,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.375000,0.323937,0.226562,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.625000,0.676063,0.773438,2.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.437500,0.364906,0.232422,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.437500,0.364906,0.232422,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.562500,0.635094,0.767578,2.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.380208,0.291501,0.188124,1.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.380208,0.291501,0.188124,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(0.619792,0.708499,0.811876,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(1.000000,5.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(0.479167,0.418044,0.272027,1.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(0.479167,0.418044,0.272027,0.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(0.520833,0.581956,0.727973,0.000000);//(Unknown)
