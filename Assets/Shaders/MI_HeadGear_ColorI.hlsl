...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[9] = float4(0.100000,0.100000,0.100000,1.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.100000,0.100000,0.100000,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(0.900000,0.900000,0.900000,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(1.000000,5.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(0.065000,0.065000,0.065000,1.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(0.065000,0.065000,0.065000,0.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(0.935000,0.935000,0.935000,0.000000);//(Unknown)
