...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[9] = float4(0.035000,0.035000,0.035000,1.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.035000,0.035000,0.035000,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(0.965000,0.965000,0.965000,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(1.000000,5.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(0.067708,0.067708,0.067708,1.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(0.067708,0.067708,0.067708,0.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(0.932292,0.932292,0.932292,0.000000);//(Unknown)
