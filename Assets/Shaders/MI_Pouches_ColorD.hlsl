...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.291667,0.211989,0.168620,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.291667,0.211989,0.168620,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.708333,0.788011,0.831380,2.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.156250,0.127182,0.112305,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.156250,0.127182,0.112305,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.843750,0.872818,0.887695,2.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.177083,0.125264,0.096842,1.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.177083,0.125264,0.096842,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(0.822917,0.874736,0.903158,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(1.000000,5.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(0.119538,0.114435,0.099899,1.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(0.119538,0.114435,0.099899,0.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(0.880462,0.885565,0.900101,0.000000);//(Unknown)
