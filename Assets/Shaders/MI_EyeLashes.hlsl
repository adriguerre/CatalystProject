...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.749088,0.000000,0.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local5 = PositiveClampedPow(Local3.a,Material.PreshaderBuffer[2].x);

	PixelMaterialInputs.EmissiveColor = Local0;
	PixelMaterialInputs.Opacity = Local5;
	...
	PixelMaterialInputs.Refraction = MaterialFloat3(MaterialFloat3(1.00000000,0.00000000,0.00000000).xy,Material.PreshaderBuffer[2].y);
	PixelMaterialInputs.PixelDepthOffset = 0.00000000;
	PixelMaterialInputs.ShadingModel = 7;
