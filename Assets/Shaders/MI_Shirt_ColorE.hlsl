...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.192981,0.197917,0.153592,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.192981,0.197917,0.153592,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.807019,0.802083,0.846408,2.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.145483,0.151042,0.098614,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.145483,0.151042,0.098614,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.854517,0.848958,0.901386,2.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.164169,0.171875,0.112793,1.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.164169,0.171875,0.112793,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(0.835831,0.828125,0.887207,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(1.000000,5.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(0.133799,0.135417,0.113553,1.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(0.133799,0.135417,0.113553,0.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(0.866201,0.864583,0.886447,0.000000);//(Unknown)
