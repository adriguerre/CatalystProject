...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.338542,0.246058,0.195719,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.338542,0.246058,0.195719,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.661458,0.753942,0.804281,2.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.203125,0.160438,0.138590,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.203125,0.160438,0.138590,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.796875,0.839562,0.861410,2.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.161458,0.124531,0.104276,1.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.161458,0.124531,0.104276,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(0.838542,0.875469,0.895724,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(1.000000,5.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(0.187500,0.157007,0.139648,1.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(0.187500,0.157007,0.139648,0.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(0.812500,0.842993,0.860352,0.000000);//(Unknown)
