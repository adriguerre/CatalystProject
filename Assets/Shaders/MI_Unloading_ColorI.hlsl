...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.062500,0.062500,0.062500,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.062500,0.062500,0.062500,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.937500,0.937500,0.937500,2.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.078125,0.078125,0.078125,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.078125,0.078125,0.078125,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.921875,0.921875,0.921875,2.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.065000,0.065000,0.065000,1.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.065000,0.065000,0.065000,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(0.935000,0.935000,0.935000,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(1.000000,5.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(0.035000,0.035000,0.035000,1.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(0.035000,0.035000,0.035000,0.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(0.965000,0.965000,0.965000,0.000000);//(Unknown)
