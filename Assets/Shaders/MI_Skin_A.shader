Shader "Unreal/MI_Skin_A"
{
    Properties
    {
		...
		Material_Texture2D_0( "Normal Map", 2D ) = "white" {}
		Material_Texture2D_1( "BaseColor Map", 2D ) = "white" {}
		Material_Texture2D_2( "ORM Map", 2D ) = "white" {}
