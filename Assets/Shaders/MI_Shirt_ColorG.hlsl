...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.083333,0.083333,0.083333,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.083333,0.083333,0.083333,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.916667,0.916667,0.916667,2.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.291667,0.276786,0.264323,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.291667,0.276786,0.264323,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.708333,0.723214,0.735677,2.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.432292,0.395741,0.361060,1.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.432292,0.395741,0.361060,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(0.567708,0.604259,0.638940,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(1.000000,5.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(0.312500,0.288821,0.260417,1.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(0.312500,0.288821,0.260417,0.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(0.687500,0.711179,0.739583,0.000000);//(Unknown)
