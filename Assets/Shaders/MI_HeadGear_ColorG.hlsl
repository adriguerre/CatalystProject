...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.093750,0.093750,0.093750,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.093750,0.093750,0.093750,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.906250,0.906250,0.906250,2.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.093750,0.088967,0.084961,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.093750,0.088967,0.084961,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.906250,0.911033,0.915039,2.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.229167,0.209790,0.191405,1.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.229167,0.209790,0.191405,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(0.770833,0.790210,0.808595,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(1.000000,5.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(0.244792,0.230880,0.214193,1.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(0.244792,0.230880,0.214193,0.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(0.755208,0.769120,0.785807,0.000000);//(Unknown)
