...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[13] = float4(0.052725,0.051432,0.062500,1.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(0.052725,0.051432,0.062500,0.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(0.947275,0.948568,0.937500,0.000000);//(Unknown)
