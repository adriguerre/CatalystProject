...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.500000,0.500000,0.500000,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.500000,0.500000,0.500000,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.500000,0.500000,0.500000,2.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.500000,0.500000,0.500000,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.500000,0.500000,0.500000,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.500000,0.500000,0.500000,2.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.317708,0.128768,0.068069,1.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.317708,0.128768,0.068069,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(0.682292,0.871232,0.931931,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(1.000000,2.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(0.192708,0.192708,0.192708,1.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(0.192708,0.192708,0.192708,0.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(0.807292,0.807292,0.807292,0.000000);//(Unknown)
	Material.PreshaderBuffer[16] = float4(1.000000,1.000000,0.400000,0.400000);//(Unknown)
