Shader "Unreal/MI_Unloading_ColorC"
{
    Properties
    {
		...
		Material_Texture2D_1( "Emiisive", 2D ) = "white" {}
		Material_Texture2D_2( "Tile D", 2D ) = "white" {}
		Material_Texture2D_3( "IDMap", 2D ) = "white" {}
		Material_Texture2D_4( "Tile C", 2D ) = "white" {}
		Material_Texture2D_5( "Tile B", 2D ) = "white" {}
		Material_Texture2D_6( "Diffuse", 2D ) = "white" {}
		Material_Texture2D_7( "Tile A", 2D ) = "white" {}
		Material_Texture2D_8( "ORM", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Unloading_ColorC.hlsl"
