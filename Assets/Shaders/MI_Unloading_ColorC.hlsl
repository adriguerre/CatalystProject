...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.218750,0.202681,0.172037,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.218750,0.202681,0.172037,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.781250,0.797319,0.827963,2.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.130208,0.119406,0.099691,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.130208,0.119406,0.099691,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.869792,0.880594,0.900309,2.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.213542,0.183581,0.140137,1.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.213542,0.183581,0.140137,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(0.786458,0.816419,0.859863,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(1.000000,5.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(0.177083,0.149407,0.110162,1.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(0.177083,0.149407,0.110162,0.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(0.822917,0.850593,0.889838,0.000000);//(Unknown)
