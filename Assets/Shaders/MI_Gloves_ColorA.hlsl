...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.473958,0.372926,0.180203,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.473958,0.372926,0.180203,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.526042,0.627074,0.819797,2.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.062500,0.061233,0.058920,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.062500,0.061233,0.058920,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.937500,0.938767,0.941080,2.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.156250,0.110204,0.075768,1.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.156250,0.110204,0.075768,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(0.843750,0.889796,0.924232,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(1.000000,2.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(0.281250,0.199800,0.120798,1.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(0.281250,0.199800,0.120798,0.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(0.718750,0.800200,0.879202,0.000000);//(Unknown)
	Material.PreshaderBuffer[16] = float4(1.000000,0.500000,0.371429,0.323810);//(Unknown)
